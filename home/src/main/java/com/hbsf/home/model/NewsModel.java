...
public class NewsModel extends BaseModel<NewsChannlesContract.Persenter, NewsApi>  implements NewsChannlesContract.Model {

    private NewsChannelsListBean newsChannelsListBean;
    public NewsModel(NewsChannlesContract.Persenter persenter) {
        super(persenter);
